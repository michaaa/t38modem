...
*/
swig_class cOpalProductDescription;
...
*/
swig_class cOpalParamRegistration;
...
*/
swig_class cOpalStatusRegistration;
...
*/
swig_class cOpalParamSetUpCall;
...
*/
swig_class cOpalStatusIncomingCall;
...
*/
swig_class cOpalStatusMediaStream;
...
*/
swig_class cOpalParamSetUserData;
...
*/
swig_class cOpalStatusUserInput;
...
*/
swig_class cOpalStatusMessageWaiting;
...
*/
swig_class cOpalStatusLineAppearance;
...
*/
swig_class cOpalParamRecording;
...
*/
swig_class cOpalStatusCallCleared;
...
*/
swig_class cOpalParamCallCleared;
...
*/
swig_class cOpalMessage_m_param;
...
SWIGEXPORT void Init_opal(void) {
  ...
  cOpalParamGeneral.klass = rb_define_class_under(mOpal, "OpalParamGeneral", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamGeneral, (void *) &cOpalParamGeneral);
  rb_define_alloc_func(cOpalParamGeneral.klass, _wrap_OpalParamGeneral_allocate);
  rb_define_method(cOpalParamGeneral.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamGeneral), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioRecordDevice=", VALUEFUNC(_wrap_OpalParamGeneral_m_audioRecordDevice_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioRecordDevice", VALUEFUNC(_wrap_OpalParamGeneral_m_audioRecordDevice_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioPlayerDevice=", VALUEFUNC(_wrap_OpalParamGeneral_m_audioPlayerDevice_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioPlayerDevice", VALUEFUNC(_wrap_OpalParamGeneral_m_audioPlayerDevice_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoInputDevice=", VALUEFUNC(_wrap_OpalParamGeneral_m_videoInputDevice_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoInputDevice", VALUEFUNC(_wrap_OpalParamGeneral_m_videoInputDevice_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoOutputDevice=", VALUEFUNC(_wrap_OpalParamGeneral_m_videoOutputDevice_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoOutputDevice", VALUEFUNC(_wrap_OpalParamGeneral_m_videoOutputDevice_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoPreviewDevice=", VALUEFUNC(_wrap_OpalParamGeneral_m_videoPreviewDevice_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_videoPreviewDevice", VALUEFUNC(_wrap_OpalParamGeneral_m_videoPreviewDevice_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaOrder=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaOrder_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaOrder", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaOrder_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaMask=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaMask_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaMask", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaMask_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_autoRxMedia=", VALUEFUNC(_wrap_OpalParamGeneral_m_autoRxMedia_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_autoRxMedia", VALUEFUNC(_wrap_OpalParamGeneral_m_autoRxMedia_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_autoTxMedia=", VALUEFUNC(_wrap_OpalParamGeneral_m_autoTxMedia_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_autoTxMedia", VALUEFUNC(_wrap_OpalParamGeneral_m_autoTxMedia_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_natRouter=", VALUEFUNC(_wrap_OpalParamGeneral_m_natRouter_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_natRouter", VALUEFUNC(_wrap_OpalParamGeneral_m_natRouter_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_stunServer=", VALUEFUNC(_wrap_OpalParamGeneral_m_stunServer_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_stunServer", VALUEFUNC(_wrap_OpalParamGeneral_m_stunServer_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_tcpPortBase=", VALUEFUNC(_wrap_OpalParamGeneral_m_tcpPortBase_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_tcpPortBase", VALUEFUNC(_wrap_OpalParamGeneral_m_tcpPortBase_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_tcpPortMax=", VALUEFUNC(_wrap_OpalParamGeneral_m_tcpPortMax_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_tcpPortMax", VALUEFUNC(_wrap_OpalParamGeneral_m_tcpPortMax_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_udpPortBase=", VALUEFUNC(_wrap_OpalParamGeneral_m_udpPortBase_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_udpPortBase", VALUEFUNC(_wrap_OpalParamGeneral_m_udpPortBase_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_udpPortMax=", VALUEFUNC(_wrap_OpalParamGeneral_m_udpPortMax_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_udpPortMax", VALUEFUNC(_wrap_OpalParamGeneral_m_udpPortMax_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpPortBase=", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpPortBase_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpPortBase", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpPortBase_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpPortMax=", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpPortMax_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpPortMax", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpPortMax_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpTypeOfService=", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpTypeOfService_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpTypeOfService", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpTypeOfService_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpMaxPayloadSize=", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpMaxPayloadSize_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_rtpMaxPayloadSize", VALUEFUNC(_wrap_OpalParamGeneral_m_rtpMaxPayloadSize_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_minAudioJitter=", VALUEFUNC(_wrap_OpalParamGeneral_m_minAudioJitter_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_minAudioJitter", VALUEFUNC(_wrap_OpalParamGeneral_m_minAudioJitter_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_maxAudioJitter=", VALUEFUNC(_wrap_OpalParamGeneral_m_maxAudioJitter_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_maxAudioJitter", VALUEFUNC(_wrap_OpalParamGeneral_m_maxAudioJitter_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceDetectMode=", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceDetectMode_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceDetectMode", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceDetectMode_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceThreshold=", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceThreshold_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceThreshold", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceThreshold_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_signalDeadband=", VALUEFUNC(_wrap_OpalParamGeneral_m_signalDeadband_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_signalDeadband", VALUEFUNC(_wrap_OpalParamGeneral_m_signalDeadband_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceDeadband=", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceDeadband_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceDeadband", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceDeadband_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceAdaptPeriod=", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceAdaptPeriod_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_silenceAdaptPeriod", VALUEFUNC(_wrap_OpalParamGeneral_m_silenceAdaptPeriod_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_echoCancellation=", VALUEFUNC(_wrap_OpalParamGeneral_m_echoCancellation_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_echoCancellation", VALUEFUNC(_wrap_OpalParamGeneral_m_echoCancellation_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioBuffers=", VALUEFUNC(_wrap_OpalParamGeneral_m_audioBuffers_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioBuffers", VALUEFUNC(_wrap_OpalParamGeneral_m_audioBuffers_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaReadData=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaReadData_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaReadData", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaReadData_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaWriteData=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaWriteData_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaWriteData", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaWriteData_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaDataHeader=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaDataHeader_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaDataHeader", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaDataHeader_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_messageAvailable=", VALUEFUNC(_wrap_OpalParamGeneral_m_messageAvailable_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_messageAvailable", VALUEFUNC(_wrap_OpalParamGeneral_m_messageAvailable_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaOptions=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaOptions_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaOptions", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaOptions_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioBufferTime=", VALUEFUNC(_wrap_OpalParamGeneral_m_audioBufferTime_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_audioBufferTime", VALUEFUNC(_wrap_OpalParamGeneral_m_audioBufferTime_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_manualAlerting=", VALUEFUNC(_wrap_OpalParamGeneral_m_manualAlerting_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_manualAlerting", VALUEFUNC(_wrap_OpalParamGeneral_m_manualAlerting_get), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaTiming=", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaTiming_set), -1);
  rb_define_method(cOpalParamGeneral.klass, "m_mediaTiming", VALUEFUNC(_wrap_OpalParamGeneral_m_mediaTiming_get), -1);
  cOpalParamGeneral.mark = 0;
  cOpalParamGeneral.destroy = (void (*)(void *)) free_OpalParamGeneral;
  cOpalParamGeneral.trackObjects = 0;
  
  cOpalProductDescription.klass = rb_define_class_under(mOpal, "OpalProductDescription", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalProductDescription, (void *) &cOpalProductDescription);
  rb_define_alloc_func(cOpalProductDescription.klass, _wrap_OpalProductDescription_allocate);
  rb_define_method(cOpalProductDescription.klass, "initialize", VALUEFUNC(_wrap_new_OpalProductDescription), -1);
  rb_define_method(cOpalProductDescription.klass, "m_vendor=", VALUEFUNC(_wrap_OpalProductDescription_m_vendor_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_vendor", VALUEFUNC(_wrap_OpalProductDescription_m_vendor_get), -1);
  rb_define_method(cOpalProductDescription.klass, "m_name=", VALUEFUNC(_wrap_OpalProductDescription_m_name_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_name", VALUEFUNC(_wrap_OpalProductDescription_m_name_get), -1);
  rb_define_method(cOpalProductDescription.klass, "m_version=", VALUEFUNC(_wrap_OpalProductDescription_m_version_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_version", VALUEFUNC(_wrap_OpalProductDescription_m_version_get), -1);
  rb_define_method(cOpalProductDescription.klass, "m_t35CountryCode=", VALUEFUNC(_wrap_OpalProductDescription_m_t35CountryCode_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_t35CountryCode", VALUEFUNC(_wrap_OpalProductDescription_m_t35CountryCode_get), -1);
  rb_define_method(cOpalProductDescription.klass, "m_t35Extension=", VALUEFUNC(_wrap_OpalProductDescription_m_t35Extension_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_t35Extension", VALUEFUNC(_wrap_OpalProductDescription_m_t35Extension_get), -1);
  rb_define_method(cOpalProductDescription.klass, "m_manufacturerCode=", VALUEFUNC(_wrap_OpalProductDescription_m_manufacturerCode_set), -1);
  rb_define_method(cOpalProductDescription.klass, "m_manufacturerCode", VALUEFUNC(_wrap_OpalProductDescription_m_manufacturerCode_get), -1);
  cOpalProductDescription.mark = 0;
  cOpalProductDescription.destroy = (void (*)(void *)) free_OpalProductDescription;
  cOpalProductDescription.trackObjects = 0;
  
  cOpalParamProtocol.klass = rb_define_class_under(mOpal, "OpalParamProtocol", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamProtocol, (void *) &cOpalParamProtocol);
  rb_define_alloc_func(cOpalParamProtocol.klass, _wrap_OpalParamProtocol_allocate);
  rb_define_method(cOpalParamProtocol.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamProtocol), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_prefix=", VALUEFUNC(_wrap_OpalParamProtocol_m_prefix_set), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_prefix", VALUEFUNC(_wrap_OpalParamProtocol_m_prefix_get), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_userName=", VALUEFUNC(_wrap_OpalParamProtocol_m_userName_set), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_userName", VALUEFUNC(_wrap_OpalParamProtocol_m_userName_get), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_displayName=", VALUEFUNC(_wrap_OpalParamProtocol_m_displayName_set), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_displayName", VALUEFUNC(_wrap_OpalParamProtocol_m_displayName_get), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_product=", VALUEFUNC(_wrap_OpalParamProtocol_m_product_set), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_product", VALUEFUNC(_wrap_OpalParamProtocol_m_product_get), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_interfaceAddresses=", VALUEFUNC(_wrap_OpalParamProtocol_m_interfaceAddresses_set), -1);
  rb_define_method(cOpalParamProtocol.klass, "m_interfaceAddresses", VALUEFUNC(_wrap_OpalParamProtocol_m_interfaceAddresses_get), -1);
  cOpalParamProtocol.mark = 0;
  cOpalParamProtocol.destroy = (void (*)(void *)) free_OpalParamProtocol;
  cOpalParamProtocol.trackObjects = 0;
  ...
  cOpalParamRegistration.klass = rb_define_class_under(mOpal, "OpalParamRegistration", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamRegistration, (void *) &cOpalParamRegistration);
  rb_define_alloc_func(cOpalParamRegistration.klass, _wrap_OpalParamRegistration_allocate);
  rb_define_method(cOpalParamRegistration.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamRegistration), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_protocol=", VALUEFUNC(_wrap_OpalParamRegistration_m_protocol_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_protocol", VALUEFUNC(_wrap_OpalParamRegistration_m_protocol_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_identifier=", VALUEFUNC(_wrap_OpalParamRegistration_m_identifier_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_identifier", VALUEFUNC(_wrap_OpalParamRegistration_m_identifier_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_hostName=", VALUEFUNC(_wrap_OpalParamRegistration_m_hostName_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_hostName", VALUEFUNC(_wrap_OpalParamRegistration_m_hostName_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_authUserName=", VALUEFUNC(_wrap_OpalParamRegistration_m_authUserName_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_authUserName", VALUEFUNC(_wrap_OpalParamRegistration_m_authUserName_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_password=", VALUEFUNC(_wrap_OpalParamRegistration_m_password_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_password", VALUEFUNC(_wrap_OpalParamRegistration_m_password_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_adminEntity=", VALUEFUNC(_wrap_OpalParamRegistration_m_adminEntity_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_adminEntity", VALUEFUNC(_wrap_OpalParamRegistration_m_adminEntity_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_timeToLive=", VALUEFUNC(_wrap_OpalParamRegistration_m_timeToLive_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_timeToLive", VALUEFUNC(_wrap_OpalParamRegistration_m_timeToLive_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_restoreTime=", VALUEFUNC(_wrap_OpalParamRegistration_m_restoreTime_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_restoreTime", VALUEFUNC(_wrap_OpalParamRegistration_m_restoreTime_get), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_eventPackage=", VALUEFUNC(_wrap_OpalParamRegistration_m_eventPackage_set), -1);
  rb_define_method(cOpalParamRegistration.klass, "m_eventPackage", VALUEFUNC(_wrap_OpalParamRegistration_m_eventPackage_get), -1);
  cOpalParamRegistration.mark = 0;
  cOpalParamRegistration.destroy = (void (*)(void *)) free_OpalParamRegistration;
  cOpalParamRegistration.trackObjects = 0;
  ...
  cOpalStatusRegistration.klass = rb_define_class_under(mOpal, "OpalStatusRegistration", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusRegistration, (void *) &cOpalStatusRegistration);
  rb_define_alloc_func(cOpalStatusRegistration.klass, _wrap_OpalStatusRegistration_allocate);
  rb_define_method(cOpalStatusRegistration.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusRegistration), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_protocol=", VALUEFUNC(_wrap_OpalStatusRegistration_m_protocol_set), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_protocol", VALUEFUNC(_wrap_OpalStatusRegistration_m_protocol_get), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_serverName=", VALUEFUNC(_wrap_OpalStatusRegistration_m_serverName_set), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_serverName", VALUEFUNC(_wrap_OpalStatusRegistration_m_serverName_get), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_error=", VALUEFUNC(_wrap_OpalStatusRegistration_m_error_set), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_error", VALUEFUNC(_wrap_OpalStatusRegistration_m_error_get), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_status=", VALUEFUNC(_wrap_OpalStatusRegistration_m_status_set), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_status", VALUEFUNC(_wrap_OpalStatusRegistration_m_status_get), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_product=", VALUEFUNC(_wrap_OpalStatusRegistration_m_product_set), -1);
  rb_define_method(cOpalStatusRegistration.klass, "m_product", VALUEFUNC(_wrap_OpalStatusRegistration_m_product_get), -1);
  cOpalStatusRegistration.mark = 0;
  cOpalStatusRegistration.destroy = (void (*)(void *)) free_OpalStatusRegistration;
  cOpalStatusRegistration.trackObjects = 0;
  
  cOpalParamSetUpCall.klass = rb_define_class_under(mOpal, "OpalParamSetUpCall", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamSetUpCall, (void *) &cOpalParamSetUpCall);
  rb_define_alloc_func(cOpalParamSetUpCall.klass, _wrap_OpalParamSetUpCall_allocate);
  rb_define_method(cOpalParamSetUpCall.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamSetUpCall), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_partyA=", VALUEFUNC(_wrap_OpalParamSetUpCall_m_partyA_set), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_partyA", VALUEFUNC(_wrap_OpalParamSetUpCall_m_partyA_get), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_partyB=", VALUEFUNC(_wrap_OpalParamSetUpCall_m_partyB_set), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_partyB", VALUEFUNC(_wrap_OpalParamSetUpCall_m_partyB_get), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_callToken=", VALUEFUNC(_wrap_OpalParamSetUpCall_m_callToken_set), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_callToken", VALUEFUNC(_wrap_OpalParamSetUpCall_m_callToken_get), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_alertingType=", VALUEFUNC(_wrap_OpalParamSetUpCall_m_alertingType_set), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_alertingType", VALUEFUNC(_wrap_OpalParamSetUpCall_m_alertingType_get), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_protocolCallId=", VALUEFUNC(_wrap_OpalParamSetUpCall_m_protocolCallId_set), -1);
  rb_define_method(cOpalParamSetUpCall.klass, "m_protocolCallId", VALUEFUNC(_wrap_OpalParamSetUpCall_m_protocolCallId_get), -1);
  cOpalParamSetUpCall.mark = 0;
  cOpalParamSetUpCall.destroy = (void (*)(void *)) free_OpalParamSetUpCall;
  cOpalParamSetUpCall.trackObjects = 0;
  
  cOpalStatusIncomingCall.klass = rb_define_class_under(mOpal, "OpalStatusIncomingCall", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusIncomingCall, (void *) &cOpalStatusIncomingCall);
  rb_define_alloc_func(cOpalStatusIncomingCall.klass, _wrap_OpalStatusIncomingCall_allocate);
  rb_define_method(cOpalStatusIncomingCall.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusIncomingCall), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_callToken=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_callToken_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_callToken", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_callToken_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_localAddress=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_localAddress_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_localAddress", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_localAddress_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remoteAddress=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remoteAddress_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remoteAddress", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remoteAddress_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remotePartyNumber=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remotePartyNumber_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remotePartyNumber", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remotePartyNumber_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remoteDisplayName=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remoteDisplayName_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_remoteDisplayName", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_remoteDisplayName_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_calledAddress=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_calledAddress_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_calledAddress", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_calledAddress_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_calledPartyNumber=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_calledPartyNumber_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_calledPartyNumber", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_calledPartyNumber_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_product=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_product_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_product", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_product_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_alertingType=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_alertingType_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_alertingType", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_alertingType_get), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_protocolCallId=", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_protocolCallId_set), -1);
  rb_define_method(cOpalStatusIncomingCall.klass, "m_protocolCallId", VALUEFUNC(_wrap_OpalStatusIncomingCall_m_protocolCallId_get), -1);
  cOpalStatusIncomingCall.mark = 0;
  cOpalStatusIncomingCall.destroy = (void (*)(void *)) free_OpalStatusIncomingCall;
  cOpalStatusIncomingCall.trackObjects = 0;
  ...
  cOpalStatusMediaStream.klass = rb_define_class_under(mOpal, "OpalStatusMediaStream", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusMediaStream, (void *) &cOpalStatusMediaStream);
  rb_define_alloc_func(cOpalStatusMediaStream.klass, _wrap_OpalStatusMediaStream_allocate);
  rb_define_method(cOpalStatusMediaStream.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusMediaStream), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_callToken=", VALUEFUNC(_wrap_OpalStatusMediaStream_m_callToken_set), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_callToken", VALUEFUNC(_wrap_OpalStatusMediaStream_m_callToken_get), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_identifier=", VALUEFUNC(_wrap_OpalStatusMediaStream_m_identifier_set), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_identifier", VALUEFUNC(_wrap_OpalStatusMediaStream_m_identifier_get), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_type=", VALUEFUNC(_wrap_OpalStatusMediaStream_m_type_set), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_type", VALUEFUNC(_wrap_OpalStatusMediaStream_m_type_get), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_format=", VALUEFUNC(_wrap_OpalStatusMediaStream_m_format_set), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_format", VALUEFUNC(_wrap_OpalStatusMediaStream_m_format_get), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_state=", VALUEFUNC(_wrap_OpalStatusMediaStream_m_state_set), -1);
  rb_define_method(cOpalStatusMediaStream.klass, "m_state", VALUEFUNC(_wrap_OpalStatusMediaStream_m_state_get), -1);
  cOpalStatusMediaStream.mark = 0;
  cOpalStatusMediaStream.destroy = (void (*)(void *)) free_OpalStatusMediaStream;
  cOpalStatusMediaStream.trackObjects = 0;
  
  cOpalParamSetUserData.klass = rb_define_class_under(mOpal, "OpalParamSetUserData", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamSetUserData, (void *) &cOpalParamSetUserData);
  rb_define_alloc_func(cOpalParamSetUserData.klass, _wrap_OpalParamSetUserData_allocate);
  rb_define_method(cOpalParamSetUserData.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamSetUserData), -1);
  rb_define_method(cOpalParamSetUserData.klass, "m_callToken=", VALUEFUNC(_wrap_OpalParamSetUserData_m_callToken_set), -1);
  rb_define_method(cOpalParamSetUserData.klass, "m_callToken", VALUEFUNC(_wrap_OpalParamSetUserData_m_callToken_get), -1);
  rb_define_method(cOpalParamSetUserData.klass, "m_userData=", VALUEFUNC(_wrap_OpalParamSetUserData_m_userData_set), -1);
  rb_define_method(cOpalParamSetUserData.klass, "m_userData", VALUEFUNC(_wrap_OpalParamSetUserData_m_userData_get), -1);
  cOpalParamSetUserData.mark = 0;
  cOpalParamSetUserData.destroy = (void (*)(void *)) free_OpalParamSetUserData;
  cOpalParamSetUserData.trackObjects = 0;
  
  cOpalStatusUserInput.klass = rb_define_class_under(mOpal, "OpalStatusUserInput", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusUserInput, (void *) &cOpalStatusUserInput);
  rb_define_alloc_func(cOpalStatusUserInput.klass, _wrap_OpalStatusUserInput_allocate);
  rb_define_method(cOpalStatusUserInput.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusUserInput), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_callToken=", VALUEFUNC(_wrap_OpalStatusUserInput_m_callToken_set), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_callToken", VALUEFUNC(_wrap_OpalStatusUserInput_m_callToken_get), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_userInput=", VALUEFUNC(_wrap_OpalStatusUserInput_m_userInput_set), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_userInput", VALUEFUNC(_wrap_OpalStatusUserInput_m_userInput_get), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_duration=", VALUEFUNC(_wrap_OpalStatusUserInput_m_duration_set), -1);
  rb_define_method(cOpalStatusUserInput.klass, "m_duration", VALUEFUNC(_wrap_OpalStatusUserInput_m_duration_get), -1);
  cOpalStatusUserInput.mark = 0;
  cOpalStatusUserInput.destroy = (void (*)(void *)) free_OpalStatusUserInput;
  cOpalStatusUserInput.trackObjects = 0;
  
  cOpalStatusMessageWaiting.klass = rb_define_class_under(mOpal, "OpalStatusMessageWaiting", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusMessageWaiting, (void *) &cOpalStatusMessageWaiting);
  rb_define_alloc_func(cOpalStatusMessageWaiting.klass, _wrap_OpalStatusMessageWaiting_allocate);
  rb_define_method(cOpalStatusMessageWaiting.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusMessageWaiting), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_party=", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_party_set), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_party", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_party_get), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_type=", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_type_set), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_type", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_type_get), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_extraInfo=", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_extraInfo_set), -1);
  rb_define_method(cOpalStatusMessageWaiting.klass, "m_extraInfo", VALUEFUNC(_wrap_OpalStatusMessageWaiting_m_extraInfo_get), -1);
  cOpalStatusMessageWaiting.mark = 0;
  cOpalStatusMessageWaiting.destroy = (void (*)(void *)) free_OpalStatusMessageWaiting;
  cOpalStatusMessageWaiting.trackObjects = 0;
  ...
  cOpalStatusLineAppearance.klass = rb_define_class_under(mOpal, "OpalStatusLineAppearance", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusLineAppearance, (void *) &cOpalStatusLineAppearance);
  rb_define_alloc_func(cOpalStatusLineAppearance.klass, _wrap_OpalStatusLineAppearance_allocate);
  rb_define_method(cOpalStatusLineAppearance.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusLineAppearance), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_line=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_line_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_line", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_line_get), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_state=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_state_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_state", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_state_get), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_appearance=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_appearance_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_appearance", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_appearance_get), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_callId=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_callId_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_callId", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_callId_get), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_partyA=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_partyA_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_partyA", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_partyA_get), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_partyB=", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_partyB_set), -1);
  rb_define_method(cOpalStatusLineAppearance.klass, "m_partyB", VALUEFUNC(_wrap_OpalStatusLineAppearance_m_partyB_get), -1);
  cOpalStatusLineAppearance.mark = 0;
  cOpalStatusLineAppearance.destroy = (void (*)(void *)) free_OpalStatusLineAppearance;
  cOpalStatusLineAppearance.trackObjects = 0;
  ...
  cOpalParamRecording.klass = rb_define_class_under(mOpal, "OpalParamRecording", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamRecording, (void *) &cOpalParamRecording);
  rb_define_alloc_func(cOpalParamRecording.klass, _wrap_OpalParamRecording_allocate);
  rb_define_method(cOpalParamRecording.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamRecording), -1);
  rb_define_method(cOpalParamRecording.klass, "m_callToken=", VALUEFUNC(_wrap_OpalParamRecording_m_callToken_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_callToken", VALUEFUNC(_wrap_OpalParamRecording_m_callToken_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_file=", VALUEFUNC(_wrap_OpalParamRecording_m_file_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_file", VALUEFUNC(_wrap_OpalParamRecording_m_file_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_channels=", VALUEFUNC(_wrap_OpalParamRecording_m_channels_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_channels", VALUEFUNC(_wrap_OpalParamRecording_m_channels_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_audioFormat=", VALUEFUNC(_wrap_OpalParamRecording_m_audioFormat_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_audioFormat", VALUEFUNC(_wrap_OpalParamRecording_m_audioFormat_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoFormat=", VALUEFUNC(_wrap_OpalParamRecording_m_videoFormat_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoFormat", VALUEFUNC(_wrap_OpalParamRecording_m_videoFormat_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoWidth=", VALUEFUNC(_wrap_OpalParamRecording_m_videoWidth_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoWidth", VALUEFUNC(_wrap_OpalParamRecording_m_videoWidth_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoHeight=", VALUEFUNC(_wrap_OpalParamRecording_m_videoHeight_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoHeight", VALUEFUNC(_wrap_OpalParamRecording_m_videoHeight_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoRate=", VALUEFUNC(_wrap_OpalParamRecording_m_videoRate_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoRate", VALUEFUNC(_wrap_OpalParamRecording_m_videoRate_get), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoMixing=", VALUEFUNC(_wrap_OpalParamRecording_m_videoMixing_set), -1);
  rb_define_method(cOpalParamRecording.klass, "m_videoMixing", VALUEFUNC(_wrap_OpalParamRecording_m_videoMixing_get), -1);
  cOpalParamRecording.mark = 0;
  cOpalParamRecording.destroy = (void (*)(void *)) free_OpalParamRecording;
  cOpalParamRecording.trackObjects = 0;
  
  cOpalStatusCallCleared.klass = rb_define_class_under(mOpal, "OpalStatusCallCleared", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalStatusCallCleared, (void *) &cOpalStatusCallCleared);
  rb_define_alloc_func(cOpalStatusCallCleared.klass, _wrap_OpalStatusCallCleared_allocate);
  rb_define_method(cOpalStatusCallCleared.klass, "initialize", VALUEFUNC(_wrap_new_OpalStatusCallCleared), -1);
  rb_define_method(cOpalStatusCallCleared.klass, "m_callToken=", VALUEFUNC(_wrap_OpalStatusCallCleared_m_callToken_set), -1);
  rb_define_method(cOpalStatusCallCleared.klass, "m_callToken", VALUEFUNC(_wrap_OpalStatusCallCleared_m_callToken_get), -1);
  rb_define_method(cOpalStatusCallCleared.klass, "m_reason=", VALUEFUNC(_wrap_OpalStatusCallCleared_m_reason_set), -1);
  rb_define_method(cOpalStatusCallCleared.klass, "m_reason", VALUEFUNC(_wrap_OpalStatusCallCleared_m_reason_get), -1);
  cOpalStatusCallCleared.mark = 0;
  cOpalStatusCallCleared.destroy = (void (*)(void *)) free_OpalStatusCallCleared;
  cOpalStatusCallCleared.trackObjects = 0;
  ...
  cOpalParamCallCleared.klass = rb_define_class_under(mOpal, "OpalParamCallCleared", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalParamCallCleared, (void *) &cOpalParamCallCleared);
  rb_define_alloc_func(cOpalParamCallCleared.klass, _wrap_OpalParamCallCleared_allocate);
  rb_define_method(cOpalParamCallCleared.klass, "initialize", VALUEFUNC(_wrap_new_OpalParamCallCleared), -1);
  rb_define_method(cOpalParamCallCleared.klass, "m_callToken=", VALUEFUNC(_wrap_OpalParamCallCleared_m_callToken_set), -1);
  rb_define_method(cOpalParamCallCleared.klass, "m_callToken", VALUEFUNC(_wrap_OpalParamCallCleared_m_callToken_get), -1);
  rb_define_method(cOpalParamCallCleared.klass, "m_reason=", VALUEFUNC(_wrap_OpalParamCallCleared_m_reason_set), -1);
  rb_define_method(cOpalParamCallCleared.klass, "m_reason", VALUEFUNC(_wrap_OpalParamCallCleared_m_reason_get), -1);
  cOpalParamCallCleared.mark = 0;
  cOpalParamCallCleared.destroy = (void (*)(void *)) free_OpalParamCallCleared;
  cOpalParamCallCleared.trackObjects = 0;
  
  cOpalMessage.klass = rb_define_class_under(mOpal, "OpalMessage", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalMessage, (void *) &cOpalMessage);
  rb_define_alloc_func(cOpalMessage.klass, _wrap_OpalMessage_allocate);
  rb_define_method(cOpalMessage.klass, "initialize", VALUEFUNC(_wrap_new_OpalMessage), -1);
  rb_define_method(cOpalMessage.klass, "m_type=", VALUEFUNC(_wrap_OpalMessage_m_type_set), -1);
  rb_define_method(cOpalMessage.klass, "m_type", VALUEFUNC(_wrap_OpalMessage_m_type_get), -1);
  rb_define_method(cOpalMessage.klass, "m_param", VALUEFUNC(_wrap_OpalMessage_m_param_get), -1);
  cOpalMessage.mark = 0;
  cOpalMessage.destroy = (void (*)(void *)) free_OpalMessage;
  cOpalMessage.trackObjects = 0;
  
  cOpalMessage_m_param.klass = rb_define_class_under(mOpal, "OpalMessage_m_param", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalMessage_m_param, (void *) &cOpalMessage_m_param);
  rb_define_alloc_func(cOpalMessage_m_param.klass, _wrap_OpalMessage_m_param_allocate);
  rb_define_method(cOpalMessage_m_param.klass, "initialize", VALUEFUNC(_wrap_new_OpalMessage_m_param), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_commandError=", VALUEFUNC(_wrap_OpalMessage_m_param_m_commandError_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_commandError", VALUEFUNC(_wrap_OpalMessage_m_param_m_commandError_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_general=", VALUEFUNC(_wrap_OpalMessage_m_param_m_general_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_general", VALUEFUNC(_wrap_OpalMessage_m_param_m_general_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_protocol=", VALUEFUNC(_wrap_OpalMessage_m_param_m_protocol_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_protocol", VALUEFUNC(_wrap_OpalMessage_m_param_m_protocol_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_registrationInfo=", VALUEFUNC(_wrap_OpalMessage_m_param_m_registrationInfo_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_registrationInfo", VALUEFUNC(_wrap_OpalMessage_m_param_m_registrationInfo_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_registrationStatus=", VALUEFUNC(_wrap_OpalMessage_m_param_m_registrationStatus_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_registrationStatus", VALUEFUNC(_wrap_OpalMessage_m_param_m_registrationStatus_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callSetUp=", VALUEFUNC(_wrap_OpalMessage_m_param_m_callSetUp_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callSetUp", VALUEFUNC(_wrap_OpalMessage_m_param_m_callSetUp_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callToken=", VALUEFUNC(_wrap_OpalMessage_m_param_m_callToken_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callToken", VALUEFUNC(_wrap_OpalMessage_m_param_m_callToken_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_incomingCall=", VALUEFUNC(_wrap_OpalMessage_m_param_m_incomingCall_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_incomingCall", VALUEFUNC(_wrap_OpalMessage_m_param_m_incomingCall_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_userInput=", VALUEFUNC(_wrap_OpalMessage_m_param_m_userInput_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_userInput", VALUEFUNC(_wrap_OpalMessage_m_param_m_userInput_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_messageWaiting=", VALUEFUNC(_wrap_OpalMessage_m_param_m_messageWaiting_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_messageWaiting", VALUEFUNC(_wrap_OpalMessage_m_param_m_messageWaiting_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_lineAppearance=", VALUEFUNC(_wrap_OpalMessage_m_param_m_lineAppearance_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_lineAppearance", VALUEFUNC(_wrap_OpalMessage_m_param_m_lineAppearance_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callCleared=", VALUEFUNC(_wrap_OpalMessage_m_param_m_callCleared_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_callCleared", VALUEFUNC(_wrap_OpalMessage_m_param_m_callCleared_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_clearCall=", VALUEFUNC(_wrap_OpalMessage_m_param_m_clearCall_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_clearCall", VALUEFUNC(_wrap_OpalMessage_m_param_m_clearCall_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_mediaStream=", VALUEFUNC(_wrap_OpalMessage_m_param_m_mediaStream_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_mediaStream", VALUEFUNC(_wrap_OpalMessage_m_param_m_mediaStream_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_setUserData=", VALUEFUNC(_wrap_OpalMessage_m_param_m_setUserData_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_setUserData", VALUEFUNC(_wrap_OpalMessage_m_param_m_setUserData_get), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_recording=", VALUEFUNC(_wrap_OpalMessage_m_param_m_recording_set), -1);
  rb_define_method(cOpalMessage_m_param.klass, "m_recording", VALUEFUNC(_wrap_OpalMessage_m_param_m_recording_get), -1);
  cOpalMessage_m_param.mark = 0;
  cOpalMessage_m_param.destroy = (void (*)(void *)) free_OpalMessage_m_param;
  cOpalMessage_m_param.trackObjects = 0;
  
  cOpalMessagePtr.klass = rb_define_class_under(mOpal, "OpalMessagePtr", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalMessagePtr, (void *) &cOpalMessagePtr);
  rb_define_alloc_func(cOpalMessagePtr.klass, _wrap_OpalMessagePtr_allocate);
  rb_define_method(cOpalMessagePtr.klass, "initialize", VALUEFUNC(_wrap_new_OpalMessagePtr), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetType", VALUEFUNC(_wrap_OpalMessagePtr_GetType), -1);
  rb_define_method(cOpalMessagePtr.klass, "SetType", VALUEFUNC(_wrap_OpalMessagePtr_SetType), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetCallToken", VALUEFUNC(_wrap_OpalMessagePtr_GetCallToken), -1);
  rb_define_method(cOpalMessagePtr.klass, "SetCallToken", VALUEFUNC(_wrap_OpalMessagePtr_SetCallToken), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetCommandError", VALUEFUNC(_wrap_OpalMessagePtr_GetCommandError), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetGeneralParams", VALUEFUNC(_wrap_OpalMessagePtr_GetGeneralParams), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetProtocolParams", VALUEFUNC(_wrap_OpalMessagePtr_GetProtocolParams), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetRegistrationInfo", VALUEFUNC(_wrap_OpalMessagePtr_GetRegistrationInfo), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetRegistrationStatus", VALUEFUNC(_wrap_OpalMessagePtr_GetRegistrationStatus), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetCallSetUp", VALUEFUNC(_wrap_OpalMessagePtr_GetCallSetUp), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetIncomingCall", VALUEFUNC(_wrap_OpalMessagePtr_GetIncomingCall), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetUserInput", VALUEFUNC(_wrap_OpalMessagePtr_GetUserInput), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetMessageWaiting", VALUEFUNC(_wrap_OpalMessagePtr_GetMessageWaiting), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetLineAppearance", VALUEFUNC(_wrap_OpalMessagePtr_GetLineAppearance), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetCallCleared", VALUEFUNC(_wrap_OpalMessagePtr_GetCallCleared), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetClearCall", VALUEFUNC(_wrap_OpalMessagePtr_GetClearCall), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetMediaStream", VALUEFUNC(_wrap_OpalMessagePtr_GetMediaStream), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetSetUserData", VALUEFUNC(_wrap_OpalMessagePtr_GetSetUserData), -1);
  rb_define_method(cOpalMessagePtr.klass, "GetRecording", VALUEFUNC(_wrap_OpalMessagePtr_GetRecording), -1);
  cOpalMessagePtr.mark = 0;
  cOpalMessagePtr.destroy = (void (*)(void *)) free_OpalMessagePtr;
  cOpalMessagePtr.trackObjects = 0;
  
  cOpalContext.klass = rb_define_class_under(mOpal, "OpalContext", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_OpalContext, (void *) &cOpalContext);
  rb_define_alloc_func(cOpalContext.klass, _wrap_OpalContext_allocate);
  rb_define_method(cOpalContext.klass, "initialize", VALUEFUNC(_wrap_new_OpalContext), -1);
  rb_define_method(cOpalContext.klass, "Initialise", VALUEFUNC(_wrap_OpalContext_Initialise), -1);
  rb_define_method(cOpalContext.klass, "IsInitialised", VALUEFUNC(_wrap_OpalContext_IsInitialised), -1);
  rb_define_method(cOpalContext.klass, "ShutDown", VALUEFUNC(_wrap_OpalContext_ShutDown), -1);
  rb_define_method(cOpalContext.klass, "GetMessage", VALUEFUNC(_wrap_OpalContext_GetMessage), -1);
  rb_define_method(cOpalContext.klass, "SendMessage", VALUEFUNC(_wrap_OpalContext_SendMessage), -1);
  rb_define_method(cOpalContext.klass, "SetUpCall", VALUEFUNC(_wrap_OpalContext_SetUpCall), -1);
  rb_define_method(cOpalContext.klass, "AnswerCall", VALUEFUNC(_wrap_OpalContext_AnswerCall), -1);
  rb_define_method(cOpalContext.klass, "ClearCall", VALUEFUNC(_wrap_OpalContext_ClearCall), -1);
  rb_define_method(cOpalContext.klass, "SendUserInput", VALUEFUNC(_wrap_OpalContext_SendUserInput), -1);
  cOpalContext.mark = 0;
  cOpalContext.destroy = (void (*)(void *)) free_OpalContext;
  cOpalContext.trackObjects = 0;
}
