 ...
 * capiutils.h
 *
 * Derived from the Linux version of this file. As that file did not have a
 * copyright notice at the top of it, I have no idea who to attribute!
 */
...
{
	((_cbyte *)m)[off]   = (_cbyte) val;
	((_cbyte *)m)[off+1] = (_cbyte)(val >> 8);
	((_cbyte *)m)[off+2] = (_cbyte)(val >> 16);
	((_cbyte *)m)[off+3] = (_cbyte)(val >> 24);
}
